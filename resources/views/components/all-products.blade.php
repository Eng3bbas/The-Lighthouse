<div class="product_grid" style="position: relative; height: 885px;">
    @forelse($products as $product)
        <div class="product" style="position: absolute; left: 0px; top: 0px;">
            <div class="product_image"><img src="{{asset("storage/" . ($product->image ?? "noimage.png"))}}" alt=""></div>
            <div class="product_extra product_{{$product->id % 2 === 0 ? "new" : "sale"}}"><a href="categories.html">{{$product->category->name}}</a></div>
